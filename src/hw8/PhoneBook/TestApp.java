 ...
 *
 * Provide two different implementations of the PhoneBook interface working with the use case below.
 * The first, (a) internally uses an ArrayList, the second (b) internally uses a HashMap.
 */
